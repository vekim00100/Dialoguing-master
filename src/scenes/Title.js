class Title extends Phaser.Scene {
    ...
    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'mickey_font', 'THE ODYSSEY', 32).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY, 'mickey_font', 'Press SPACE to start', 16).setOrigin(0.5)
